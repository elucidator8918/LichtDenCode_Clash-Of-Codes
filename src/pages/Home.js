...
const Home = () => {
  ...
  return (
    <div className="relative bg-lavender w-full h-[1024px] overflow-hidden text-left text-2xl text-black font-poppins">
      <button
      ...
      <button className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[67px] left-[514px] text-base font-semibold font-poppins text-darkslateblue-100 text-center flex items-center justify-center w-[211px] h-8">
        Home
      </button>
      ...
      <button className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[235px] left-[156px] text-2xl font-bold font-poppins text-darkslateblue-100 text-left flex items-center w-[670px] h-8">
        Welcome Back, Let’s do a Quick Search
      </button>
      <button className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[283px] left-[156px] text-base font-poppins text-black text-center flex items-center justify-center w-[255px] h-8">
      ...
      <button className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[560px] left-[687px] text-base font-poppins text-gray-100 text-left inline-block w-[383px] h-[63px]">
      ...
      <button className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[560px] left-[631px] text-base font-semibold font-poppins text-black text-left inline-block w-[399px] h-[38px]">{`Bio : `}</button>
      <button className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[735px] left-[687px] text-base font-poppins text-gray-100 text-left inline-block w-[383px] h-8">
        20 years
      </button>
      <button className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[735px] left-[631px] text-base font-semibold font-poppins text-black text-left inline-block w-[399px] h-8">{`Age : `}</button>
      <button className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[869px] left-[649px] text-base font-medium font-poppins text-black text-center inline-block w-[399px] h-8">
        Profile Score
      </button>
      <button className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[639px] left-[739px] text-base font-poppins text-gray-100 text-left inline-block w-[383px] h-8">
        Dancing, Sketching
      </button>
      <button className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[639px] left-[631px] text-base font-semibold font-poppins text-black text-left inline-block w-[399px] h-8">{`Interests: `}</button>
      <button className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[687px] left-[723px] text-base font-poppins text-gray-100 text-left inline-block w-[383px] h-8">
        Maan Meri Jaan, Apna Bana Le
      </button>
      <button className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[687px] left-[631px] text-base font-semibold font-poppins text-black text-left inline-block w-[399px] h-8">{`Spotify : `}</button>
      ...
      <div className="absolute top-[209px] left-[1122px] text-3xs font-medium text-lavender text-center inline-block w-[63px] h-[17px]">
        New
      </div>
      <img
      ...
      <div className="absolute top-[275px] left-[1250px] text-sm font-medium text-darkslategray-200 inline-block w-[148px] h-[23px]">
        New Matches
      </div>
      ...
      <div className="absolute top-[412px] left-[1250px] text-sm font-medium text-darkslategray-200 inline-block w-[148px] h-[23px]">
        All Matches
      </div>
      ...
      <div className="absolute top-[551px] left-[1250px] text-sm font-medium text-darkslategray-200 inline-block w-[148px] h-[23px]">
        Profile Visits
      </div>
      ...
      <div className="absolute top-[689px] left-[1245px] text-sm font-medium text-darkslategray-200 inline-block w-[148px] h-[23px]">
        Likes
      </div>
      <img
      ...
      <img
        className="absolute top-[892px] left-[191px] w-[70px] h-[70px] object-cover"
        alt=""
        src="../multiply@2x.png"
      />
      <img
        className="absolute top-[902px] left-[332px] w-[50px] h-[50px] overflow-hidden"
        alt=""
        src="../star-rate.svg"
      />
      <img
        className="absolute top-[892px] left-[453px] w-[70px] h-[70px] object-cover"
        alt=""
        src="../favorite@2x.png"
      />
      <button
